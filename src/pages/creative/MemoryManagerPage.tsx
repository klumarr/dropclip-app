...
import { UploadStatus, Upload } from "../../types/uploads";
...
const MemoryManagerPage = () => {
  ...
  const {
    pendingUploads: originalPendingUploads,
    approvedUploads,
    rejectedUploads,
  ...
  const pendingUploads = useMemo(
    () =>
      originalPendingUploads.filter(
        (upload) =>
          upload.status === UploadStatus.COMPLETED &&
          (!upload.moderationStatus || upload.moderationStatus === "pending")
      ),
    [originalPendingUploads]
  );
